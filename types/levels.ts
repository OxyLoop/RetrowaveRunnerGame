...
export const LEVELS: LevelConfig[] = [
    {
        ...
        spawnRate: 0.5,
        bossName: 'CYBER ENDERMAN',
        bossTaunt: 'Sistem Hatası: Entity Found!',
        bossHealth: 350,
    ...
    },
    {
        ...
        theme: 'nebula',
        distance: 600,
        enemyTypes: [EnemyType.DRONE, EnemyType.TANK, EnemyType.GLITCH, EnemyType.ASTEROID, EnemyType.PHANTOM],
        spawnRate: 0.9,
        bossName: 'CYBER ENDERMAN',
        bossTaunt: 'Gözler Üzerinde!',
        bossHealth: 650,
    ...
    },
    {
        ...
        theme: 'abyss',
        distance: 700,
        enemyTypes: [EnemyType.DRONE, EnemyType.TANK, EnemyType.GLITCH, EnemyType.PHANTOM, EnemyType.BOMBER],
        spawnRate: 1.0,
        bossName: 'CYBER ENDERMAN',
        bossTaunt: 'Sonun Geldi!',
        bossHealth: 800,
